        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-section">
            ...
            <p className="text-lg text-slate-600 leading-relaxed mb-8">
              To deliver smart, end-to-end security and IT solutions that
              protect people, property, and operations. We combine cutting-edge
              technology with local expertise to provide comprehensive security
          ...
          <div className="animate-section">
            <div className="glass rounded-2xl p-8 bg-gradient-to-br from-blue-50 to-orange-50">
              ...
              <p className="text-slate-600 leading-relaxed">
                To be the leading security technology provider in the region,
                known for innovation, reliability, and exceptional customer
                service. We envision a future where advanced security technology
                seamlessly integrates with daily operations to create safer
