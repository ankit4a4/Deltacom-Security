    ...
    <div className="min-h-screen md:mt-[120px] mt-20 bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <section ref={heroRef} className="relative py-20  overflow-hidden">
        ...
        <div className="absolute inset-0">
          ...
          />
          <div
            className={`absolute inset-0 bg-gradient-to-r from-black opacity-20`}
          ></div>
        ...
        <div className="hero-content  inset-0 flex items-center justify-center z-10">
          <div className="max-w-4xl mx-auto text-center px-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                href="/contact"
                className="px-10 py-4 bg-white text-[#013a63]  rounded-2xl font-semibold hover:bg-gray-100 transition-all duration-300 hover:scale-105"
              >
      ...
      <div ref={contentRef} className="relative z-10 -mt-10 ">
        {/* Features Section */}
        <section className="animate-section bg-gradient-to-bl from-blue-50 to to-blue-100/60 backdrop-blur-xl rounded-t-[3rem] px-6 py-20 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Our {service.title.toLowerCase()} solutions incorporate the
                latest technology to provide comprehensive security coverage.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {service.features.map((feature, index) => (
                <div
                  key={index}
                  className="group p-6 bg-white/80 backdrop-blur-sm rounded-2xl border border-gray-200/80 hover:bg-white hover:shadow-lg transition-all duration-300"
                >
                  <div
                    className={`inline-flex p-3 rounded-xl bg-gradient-to-r ${service.accent} mb-4 group-hover:scale-110 transition-transform duration-300`}
                  >
                    <CheckCircle className="h-6 w-6 text-blue-700" />
                  </div>
                  <h3 className="text-xl font-bold text-[#014f86] mb-3">
                    {feature.title}
                  </h3>
        ...
        <section className="animate-section py-20 px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl font-bold text-[#013a63]  mb-12 text-center">
        ...
        <section className="animate-section bg-white/70 backdrop-blur-xl py-20 px-6 lg:px-8">
          <div className="max-w-6xl mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-4xl font-bold text-[#013a63]   mb-8">
                ...
                <div className="space-y-4">
                  {Object.entries(service.specifications).map(
                    ([key, value]) => (
                      <div
                        key={key}
                        className="flex items-center justify-between py-3 border-b border-gray-200/50"
                      >
                        <span className="font-medium text-gray-700 capitalize">
                          {key.replace(/([A-Z])/g, " $1").trim()}
                        </span>
                        <span className="text-[#013a63]  font-semibold">
                          {value}
                        </span>
                      </div>
                    )
              ...
              <div className="bg-gradient-to-b from-[#013a63] to-[#01497c]/80 rounded-3xl p-8 text-white">
        ...
        {/* Case Study Section */}
        <section
          className="animate-section bg-gradient-to-b from-[#013a63] to-[#01497c]/80 py-20 px-6 lg:px-8"
          id="case"
        >
              ...
              <div className="grid md:grid-cols-3 gap-6">
                {service.caseStudy.results.map((result, index) => (
                  <div key={index} className="p-4 bg-gray-50 rounded-xl">
                    <CheckCircle className="h-8 w-8 text-[#013a63] mx-auto mb-3" />
        ...
        {/* CTA Section */}
        <section className="animate-section bg-blue-50 py-20 px-6 lg:px-8 text-[#013a63] ">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-800 mb-10 leading-relaxed">
              ...
              needs. Our experts will design a custom solution that scales with
              your business.
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center">
              <Link
                href="/contact"
                className={`px-10 py-4 bg-gradient-to-r ${service.accent} border text-[#013a63] font-semibold rounded-2xl hover:shadow-2xl transition-all duration-300 hover:scale-105`}
              >
                Get Free Consultation
              </Link>
            </div>
            ...
            {/* Contact Info */}
            <div className="flex items-center justify-center gap-8 mt-12 text-[#01497c]">
